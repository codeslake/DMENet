...
def feature_discriminator(feats, is_train=True, reuse=False, scope = 'feature_discriminator'):
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h0/bn1')
        n = Conv2d(d0, 64, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h0/c2')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h0/bn2')
        n = Conv2d(n, 128, (3, 3), (2, 2), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h0/c3')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h0/bn3')
        ...
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h1/bn1')
        n = Conv2d(n, 128, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h1/c2')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h1/bn2')
        n = Conv2d(n, 256, (3, 3), (2, 2), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h1/c3')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h1/bn3')
        ...
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h2/bn1')
        n = Conv2d(n, 256, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h2/c2')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h2/bn2')
        n = Conv2d(n, 512, (3, 3), (2, 2), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h2/c3')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h2/bn3')
        ...
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h3/bn1')
        n = Conv2d(n, 512, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h3/c2')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h3/bn2')
        n = Conv2d(n, 1024, (3, 3), (2, 2), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h3/c3')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h3/bn3')
        ...
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h4/bn1')
        n = Conv2d(n, 1024, (3, 3), (2, 2), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h4/c2')
        n = BatchNormLayer(n, act=lrelu, is_train=is_train, gamma_init=gamma_init, name='h4/bn2')
...
def defocus_discriminator(t_image, is_train=False, reuse=False, scope='defocus_discriminator'):
    ...
    with tf.variable_scope(scope, reuse=reuse) as vs:
        ...
        n = Conv2d(n, 128, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h1/c1')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h1/b1')
        n = Conv2d(n, 128, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h1/c2')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h1/b2')
        n = Conv2d(n, 256, (3, 3), (2, 2), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h1/c3')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h1/b3')

        n = Conv2d(n, 256, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h2/c1')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h2/b1')
        n = Conv2d(n, 256, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h2/c2')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h2/b2')
        n = Conv2d(n, 512, (3, 3), (2, 2), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h2/c3')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h2/b3')

        n = Conv2d(n, 512, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h3/c1')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h3/b1')
        n = Conv2d(n, 512, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h3/c2')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h3/b2')
        n = Conv2d(n, 1024, (3, 3), (2, 2), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h3/c3')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h3/b3')

        n = Conv2d(n, 1024, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h4/c1')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h4/b1')
        n = Conv2d(n, 1024, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, b_init=b_init, name='h4/c2')
        n = BatchNormLayer(n, is_train=is_train, gamma_init=g_init, name='h4/b2')
