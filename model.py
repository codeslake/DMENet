...
def UNet_down(image_in, is_train=False, reuse=False, scope = 'unet_down'):
    ...
    with tf.variable_scope(scope, reuse=reuse) as vs:
        ...
        f0 = n
        n = Conv2d(n, 64, (4, 4), (2, 2), act=None, padding='SAME', W_init=w_init2, name='d1/c1')
        ...
        f1_2 = n
        n = Conv2d(n, 128, (4, 4), (2, 2), act=None, padding='SAME', W_init=w_init3, name='d2/c1')
        ...
        f2_3 = n
        n = Conv2d(n, 256, (4, 4), (2, 2), act=None, padding='SAME', W_init=w_init4, name='d3/c1')
        ...
        f3_4 = n
        n = Conv2d(n, 256, (4, 4), (2, 2), act=None, padding='SAME', W_init=w_init4, name='d4/c1')
...
def UNet_up(f0_in, f1_2_in, f2_3_in, f3_4_in, last_in, hrg, wrg, is_train=False, reuse=False, scope = 'unet_up'):
    ...
    with tf.variable_scope(scope, reuse=reuse) as vs:
        ...
        n = Subpixel_Conv2d(last, scale = 2, n_out_channel = 256, name='u4/u')
        ...
        n = Subpixel_Conv2d(n, scale = 2, n_out_channel = 128, name='u3/u')
        ...
        n = Subpixel_Conv2d(n, scale = 2, n_out_channel = 128, name='u2/u')
        ...
        n = Subpixel_Conv2d(n, scale = 2, n_out_channel = 64, name='u1/u')
